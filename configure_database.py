...
conn = psycopg2.connect(dbname="postgres", user="airflow", password="airflow", host="localhost")
...
conn = psycopg2.connect(dbname="churn", user="airflow", password="airflow", host="localhost")
cur = conn.cursor()
